...
class MoleculeGroups(object):
	...
	def _build_molecule_groups(self, raw_data, sim_data):
		...
		# Ported from WholeCellEcoliRelease v3.0.1 (Choi & Covert 2023) for the kinetic tRNA charging
		# model. NOTE: UGA is deliberately KEPT as a sense codon because it encodes selenocysteine.
		# Treating 'skip stop codons' literally would give 61 codons instead of 62 and shift every
		# downstream index -- a model that runs and is quietly wrong.
		codon_ids = []
