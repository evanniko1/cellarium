...
question, executed against real isogenic simulations, the across-seed coefficient of variation is $0.047$ for
growth rate (H$_1$ refuted, below the $0.10$ threshold), $0.013$ for ribosome concentration (refuted), and
$0.119$ for ppGpp concentration (supported, exceeding the effect-size floor). The loop closes: a vague question
...
contamination, of independent interest for closed-loop AI-science systems. [A leaked-vs-quarantined ablation
quantifying the effect of contamination on downstream conclusions is reported in Extended Data.]
