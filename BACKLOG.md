...
- ✅ **Done (code shipped, CI-green):** DD-ENG-1, DD-ENG-2, DD-ENG-3, DD-ENG-4, DD-ENG-5, DD-MTH-1, DD-MTH-2, DD-AGT-1, DD-SCI-4a (a/b/c), DD-SCI-5b, DD-TCV-1 (b/c). The engineering-deepening pass from the loop-review audit is complete; DD-ENG-4/5 are the two integrity bugs the adversarial audit surfaced (`reconcile` false-'done', `data_availability` fabricated availability) — both fixed.
