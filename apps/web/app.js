...
async function runDemo() {
  ...
  const BEATS = [
    { ms: 20000, v: "A whole-cell model of E. coli — the most complete simulation in biology. From the genome, it computes a single cell's entire molecular life: sixteen thousand species, every second. It's extraordinary — and almost impossible to ask a question of. Rigorous answers take an expert days, and AI tools today optimize for novelty, not truth.", go: () => showSlide(PROBLEM) },
    ...
    { ms: 9000, v: "New experiments? Cellwright only proposes them — as drafts. Nothing simulates without your approval. Safety is a gate, not a footnote.", go: async () => { say("The launch airlock", "Cellwright <b>proposes</b>; nothing runs without <b>your approval</b>."); closeCorpus(); openDrawer("queue"); } },
    ...
    { ms: 12000, v: "The remaining operons compensate — exactly as Condon measured — with ppGpp flat. Then a live literature review reaches the theory of ribosome-limited antibiotic susceptibility, and a computational gap.", go: async () => { say("The clash, grounded", "Operons compensate (Condon 1993), ppGpp flat → <b>ribosome-limited antibiotic susceptibility</b> [Greulich–Scott 2015]."); scrollMain("#scroll", "end"); } },
