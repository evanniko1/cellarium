...
def generate_designs(k: int = 2, max_candidates: int = 8, objective: str = "viability") -> dict:
    """SCI-4: generate + rank reduced-genome / multi-KO candidate designs. objective='viability' (safest first) or
    'information' (active learning — the runs that teach the most first)."""
